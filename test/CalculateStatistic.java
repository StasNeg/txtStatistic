...
public class CalculateStatistic {
    ...
    private String getPath(Class clazz, String fileName) {
        ...
        return new File(Objects.requireNonNull(classLoader.getResource(fileName)).getFile()).getPath();
    }

    @Test
    public void CalculateStatiticInLineTest() throws IOException {

        List<FileLineModel> lines = fileLoader.getStatisticFromFileWithoutStream(new FileModel(getPath(CLIController.class, "test.txt")));
